--[[
   ...
   ─
│@b_o_y_k_a_a
تم تطوير السورس بواسطه مطور سورس بويكا ✾
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(VAMBAIR..":NameBot:")
...
elseif  UserID == 1373616147 then
var =  '𝐃𝐄𝐕 𝐕𝐀𝐌𝐁𝐄𝐑'
elseif  UserID == 1458654225 then
var =  '𝐃𝐄𝐕 𝐁𝐎𝐘𝐊𝐀🇪🇬'
elseif redis:sismember(VAMBAIR..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(VAMBAIR..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(VAMBAIR..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(VAMBAIR..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(VAMBAIR..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(VAMBAIR..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(VAMBAIR..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(VAMBAIR..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(VAMBAIR..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(VAMBAIR..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(VAMBAIR..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(VAMBAIR..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(VAMBAIR..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(VAMBAIR..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(VAMBAIR..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(VAMBAIR..':SUDO_BOT:')
message = '⋆ ** قائمه الـمـطـوريـن : \n\n`⋆ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(VAMBAIR..'username:'..v)
local count = redis:scard(VAMBAIR..'mtwr_count'..v)
...
local monsha = redis:smembers(VAMBAIR..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n⋆ قائمه المدراء :*\n\n'
local list = redis:smembers(VAMBAIR..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(VAMBAIR..'admins:'..msg.chat_id_)
...
local list = redis:smembers(VAMBAIR..'whitelist:'..msg.chat_id_)
...
if redis:sismember(VAMBAIR..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(VAMBAIR..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(VAMBAIR..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(VAMBAIR..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(VAMBAIR..'gban_users')
...
local list = redis:smembers(VAMBAIR..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(VAMBAIR..':Filter_Word:'..msg.chat_id_,word) then 
return  "⋆ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(VAMBAIR..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(VAMBAIR..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(VAMBAIR..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(VAMBAIR..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(VAMBAIR..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(VAMBAIR..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(VAMBAIR..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(VAMBAIR..'group:ids')
message = '⋆ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(VAMBAIR..'group:name'..v)
if info then 
...
redis:del(
VAMBAIR..'group:add'..id_group,
VAMBAIR..'lock_link'..id_group, 
VAMBAIR..'lock_id'..id_group,
VAMBAIR..'lock_spam'..id_group, 
VAMBAIR..'lock_webpage'..id_group,
VAMBAIR..'lock_markdown'..id_group,
VAMBAIR..'lock_flood'..id_group,
VAMBAIR..'lock_bots'..id_group,
VAMBAIR..'mute_forward'..id_group,
VAMBAIR..'mute_contact'..id_group,
VAMBAIR..'mute_location'..id_group,
VAMBAIR..'mute_document'..id_group,
VAMBAIR..'mute_keyboard'..id_group,
VAMBAIR..'mute_game'..id_group,
VAMBAIR..'mute_inline'..id_group,
VAMBAIR..'lock_username'..id_group,
VAMBAIR..'num_msg_VAMBAIR'..id_group,
VAMBAIR..'replay'..id_group
)
redis:srem(VAMBAIR..'group:ids',id_group)
end
...
redis:hset(VAMBAIR..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(VAMBAIR..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(VAMBAIR..'group:add'..msg.chat_id_) then  return '⋆ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(VAMBAIR..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(VAMBAIR..':addnumberusers') or 0)
...
local lock_service = redis:get(VAMBAIR..'lock_service')
if lock_service then 
sendMsg(msg.chat_id_,msg.id_,'⋆*تم تفعيل المجموعه . \n*⋆ ورفع كل المشرفين\n [SOURCE VAMBAIR](t.me/Xx_SorceVambair_xX)')
else
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(VAMBAIR..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(VAMBAIR..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
VAMBAIR..'group:add'..msg.chat_id_,true,
VAMBAIR..'lock_link'..msg.chat_id_,true, 
VAMBAIR..'lock_id'..msg.chat_id_,true,
VAMBAIR..'lock_spam'..msg.chat_id_,true,
VAMBAIR..'lock_webpage'..msg.chat_id_,true,
VAMBAIR..'lock_markdown'..msg.chat_id_,true,
VAMBAIR..'lock_flood'..msg.chat_id_,true,
VAMBAIR..'lock_bots'..msg.chat_id_,true,
VAMBAIR..'mute_forward'..msg.chat_id_,true,
VAMBAIR..'mute_contact'..msg.chat_id_,true,
VAMBAIR..'mute_location'..msg.chat_id_,true,
VAMBAIR..'mute_document'..msg.chat_id_,true,
VAMBAIR..'mute_keyboard'..msg.chat_id_,true,
VAMBAIR..'mute_game'..msg.chat_id_,true,
VAMBAIR..'mute_inline'..msg.chat_id_,true,
VAMBAIR..'lock_username'..msg.chat_id_,true,
VAMBAIR..'num_msg_VAMBAIR'..msg.chat_id_,5, 
VAMBAIR..'replay'..msg.chat_id_,true
)

redis:sadd(VAMBAIR..'group:ids',msg.chat_id_) 
redis:sadd(VAMBAIR..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(VAMBAIR..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(VAMBAIR..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(VAMBAIR..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(VAMBAIR..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(VAMBAIR..'username:'..UserID,'username',Resolv)
redis:sadd(VAMBAIR..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(VAMBAIR..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(VAMBAIR..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(VAMBAIR..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(VAMBAIR..'username:'..UserID,'username',Resolv)
redis:sadd(VAMBAIR..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(VAMBAIR..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(VAMBAIR..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(VAMBAIR..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(VAMBAIR..'username:'..UserID, 'username', Resolv)
redis:sadd(VAMBAIR..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(VAMBAIR..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(VAMBAIR..'whitelist:'..ChatID,UserID)
...
if redis:sismember(VAMBAIR..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(VAMBAIR..'username:'..UserID, 'username', Resolv)
redis:sadd(VAMBAIR..'owners:'..ChatID,UserID)
...
if redis:sismember(VAMBAIR..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(VAMBAIR..'username:'..UserID, 'username', Resolv)
redis:sadd(VAMBAIR..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(VAMBAIR..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(VAMBAIR..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(VAMBAIR..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(VAMBAIR..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(VAMBAIR..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(VAMBAIR..'username:'..UserID, 'username', Resolv)
redis:sadd(VAMBAIR..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(VAMBAIR..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(VAMBAIR..'banned:'..ChatID,UserID)
...
if redis:sismember(VAMBAIR..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(VAMBAIR..'username:'..UserID, 'username', Resolv)
redis:sadd(VAMBAIR..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(VAMBAIR..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(VAMBAIR..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(VAMBAIR..'username:'..UserID, 'username',Resolv)
redis:sadd(VAMBAIR..'gban_users',UserID)
...
redis:srem(VAMBAIR..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(VAMBAIR..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(VAMBAIR..'username:'..UserID, 'username', Resolv)
redis:sadd(VAMBAIR..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(VAMBAIR..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(VAMBAIR..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(VAMBAIR..'username:'..UserID, 'username', UserName)
redis:sadd(VAMBAIR..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(VAMBAIR..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'⋆ **العضو » ❪ '..UserName..' ❫\n⋆ **الايدي » ❪ `'..UserID..'` ❫\n⋆ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(VAMBAIR..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(VAMBAIR..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⋆ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(VAMBAIR..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(VAMBAIR..'username:'..UserID, 'username', Resolv)
redis:sadd(VAMBAIR..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(VAMBAIR..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(VAMBAIR..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⋆ **العضو » '..USERNAME..' \n⋆ ** الايدي » (`'..UserID..'`)\n⋆ **انه بالتأكيد ليس مطور \n') end
redis:srem(VAMBAIR..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⋆ العضو » ❪ '..USERNAME..' ❫\n⋆ الايدي » ❪ '..UserID..' ❫\n⋆ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(VAMBAIR..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(VAMBAIR..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(VAMBAIR..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(VAMBAIR..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*⋆*` اعدادات المجموعه :` \n"
.."\n⋆ التعديل «» "..(redis:get(VAMBAIR..'lock_edit'..msg.chat_id_) or 'false')
.."\n⋆ الروابط «» "..(redis:get(VAMBAIR..'lock_link'..msg.chat_id_) or 'false')
.."\n⋆ التاك «» "..(redis:get(VAMBAIR..'lock_tag'..msg.chat_id_) or 'false')
.."\n⋆ المعرفات «» "..(redis:get(VAMBAIR..'lock_username'..msg.chat_id_) or 'false')
.."\n⋆ التكرار «» "..(redis:get(VAMBAIR..'lock_flood'..msg.chat_id_) or 'false')
.."\n⋆ الكلايش «» "..(redis:get(VAMBAIR..'lock_spam'..msg.chat_id_) or 'false')
.."\n⋆ الويب «» "..(redis:get(VAMBAIR..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⋆ الماركدوان «» "..(redis:get(VAMBAIR..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⋆ بالطرد البوتات «» "..(redis:get(VAMBAIR..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⋆ البوتات «» "..(redis:get(VAMBAIR..'lock_bots'..msg.chat_id_) or 'false')
.."\n⋆ عدد التكرار «» "..(redis:get(VAMBAIR..'num_msg_VAMBAIR'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⋆`اعدادات الوسائط :`\n"
.."\n*⋆ *المتحركه «» "..(redis:get(VAMBAIR..'mute_gif'..msg.chat_id_) or 'false')
.."\n⋆ الدردشه «» "..(redis:get(VAMBAIR..'mute_text'..msg.chat_id_) or 'false')
.."\n⋆ الانلاين «» "..(redis:get(VAMBAIR..'mute_inline'..msg.chat_id_) or 'false')
.."\n⋆ الالعاب «» "..(redis:get(VAMBAIR..'mute_game'..msg.chat_id_) or 'false')
.."\n⋆ الصور «» "..(redis:get(VAMBAIR..'mute_photo'..msg.chat_id_) or 'false')
.."\n⋆ الفيديو «» "..(redis:get(VAMBAIR..'mute_video'..msg.chat_id_) or 'false')
.."\n⋆ البصمات «» "..(redis:get(VAMBAIR..'mute_audio'..msg.chat_id_) or 'false')
.."\n⋆ الصوت «» "..(redis:get(VAMBAIR..'mute_voice'..msg.chat_id_) or 'false')
.."\n⋆ الملصقات «» "..(redis:get(VAMBAIR..'mute_sticker'..msg.chat_id_) or 'false')
.."\n⋆ الجهات «» "..(redis:get(VAMBAIR..'mute_contact'..msg.chat_id_) or 'false')
.."\n⋆ التوجيه «» "..(redis:get(VAMBAIR..'mute_forward'..msg.chat_id_) or 'false')
.."\n⋆ الموقع «» "..(redis:get(VAMBAIR..'mute_location'..msg.chat_id_) or 'false')
.."\n⋆ الملفات «» "..(redis:get(VAMBAIR..'mute_document'..msg.chat_id_) or 'false')
.."\n⋆ الاشعارات «» "..(redis:get(VAMBAIR..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n⋆ الكيبورد «» "..(redis:get(VAMBAIR..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⋆*`اعدادات اخرى : `"
.."\n\n*⋆*الترحيب «» "..welcomex
.."\n*⋆*الردود «» "..replayx
...
.."\n*⋆*الويب «» "..(redis:get(VAMBAIR..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⋆*الماركدوان «» "..(redis:get(VAMBAIR..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*⋆*البوتات بالطرد «» "..(redis:get(VAMBAIR..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*⋆*البوتات «» "..(redis:get(VAMBAIR..'lock_bots'..msg.chat_id_) or 'false')
.."\n*⋆*عدد التكرار «» "..(redis:get(VAMBAIR..'num_msg_VAMBAIR'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⋆*اعدادات التقـييد :\n"
.."\n*⋆*التقييد بالتوجيه «» "..(redis:get(VAMBAIR..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالصور «» "..(redis:get(VAMBAIR..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالروابط «» "..(redis:get(VAMBAIR..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد بالمتحركه «» "..(redis:get(VAMBAIR..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*⋆*التقييد الفيديو «» "..(redis:get(VAMBAIR..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
