...
redis:set(VAMBAIR.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(VAMBAIR.."getidstatus"..msg.chat_id_, "Photo")
return  "✹ ** أهلا عزيزي "..msg.TheRankCmd.."\n✹ ** تم تفعيل الايدي بالصوره \n" 
end
function cmds_on(msg)
if not msg.Creator then return "✹ ** هذا الامر يخص {المنشئ,المطور} فقط  \n"
end
redis:set(VAMBAIR..'lock:kara:'..msg.chat_id_,'on')
return "✹ ** أهلا عزيزي "..msg.TheRankCmd.."\n✹ ** تم تعطيل الرفع في المجموعه \n"
end
function cmds_off(msg)
if not msg.Creator then return "✹ ** هذا الامر يخص {المنشئ,المطور} فقط  \n"
end
redis:set(VAMBAIR..'lock:kara:'..msg.chat_id_,'off')
...
redis:set(VAMBAIR..'lock:join:'..msg.chat_id_,true)
...
redis:del(VAMBAIR..'lock:join:'..msg.chat_id_)
return "*✹ ** أهلا عزيزي *"..msg.TheRankCmd.."*\n✹ ** تم فتح الدخول بالرابط \n*" 
end


local function iVAMBAIR(msg,MsgText)

Channel = redis:get(VAMBAIR..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(VAMBAIR..'joinchnl') then
...
redis:setex(VAMBAIR..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(VAMBAIR..'CheckExpire::'..msg.chat_id_) then 
redis:set(VAMBAIR..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(VAMBAIR..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(VAMBAIR..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(VAMBAIR..'CheckExpire::'..msg.chat_id_) then 
redis:set(VAMBAIR..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(VAMBAIR..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(VAMBAIR..'CheckExpire::'..msg.chat_id_) then 
redis:set(VAMBAIR..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(VAMBAIR..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(VAMBAIR..'CheckExpire::'..msg.chat_id_) then 
redis:set(VAMBAIR..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(VAMBAIR..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(VAMBAIR..'group:name'..msg.chat_id_) or '')
redis:set(VAMBAIR..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(VAMBAIR..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "✹ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. VAMBAIR..'')
...
if not msg.Director and redis:get(VAMBAIR..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(VAMBAIR..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "✹ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if not MsgText[2] and msg.reply_id then
if redis:get(VAMBAIR..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(VAMBAIR..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(VAMBAIR..'admins:'..msg.chat_id_)
redis:del(VAMBAIR..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(VAMBAIR..'owners:'..msg.chat_id_)
redis:del(VAMBAIR..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(VAMBAIR..'whitelist:'..msg.chat_id_)
redis:del(VAMBAIR..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "✹ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(VAMBAIR..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(VAMBAIR..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(VAMBAIR..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "✹ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(VAMBAIR..'linkGroup'..msg.sender_user_id_,300,true)
return '✹ عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(VAMBAIR..'linkGroup'..msg.chat_id_) then 
return "✹ ** اوه لا يوجد رابط .\n✹ **لانشاء رابط ارسل { `انشاء رابط` }\n" 
end
local GroupName = redis:get(VAMBAIR..'group:name'..msg.chat_id_)
local GroupLink = redis:get(VAMBAIR..'linkGroup'..msg.chat_id_)
...
local Text = "✹ رابـط الـمـجـمـوعه ✹ \n"..Flter_Markdown(redis:get(VAMBAIR..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(VAMBAIR..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "✹ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local Mn3Word = redis:scard(VAMBAIR..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "✹ ** عذراً لا توجد كلمات ممنوعه ليتم حذفها" 
end
redis:del(VAMBAIR..':Filter_Word:'..msg.chat_id_)
...
redis:del(VAMBAIR..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "✹ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
if not redis:get(VAMBAIR..'welcome:msg'..msg.chat_id_) then 
return "✹ ** اوه هنالك خطأ .\n✹ عذراً لا يوجد ترحيب ليتم مسحه ." 
end
redis:del(VAMBAIR..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(VAMBAIR..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "✹ عذراً لا يوجد منشى اساسي \n!" 
end
redis:del(VAMBAIR..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "✹ **هذا الامر يخص {المطور} فقط  \n" end
local NumMnsha = redis:scard(VAMBAIR..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "✹ عذراً لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(VAMBAIR..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(VAMBAIR..'banned:'..msg.chat_id_)
if #list == 0 then return "*✹ لا يوجد مستخدمين محظورين  *" end
message = '✹ ** قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(VAMBAIR..'banned:'..msg.chat_id_)
return "✹ **أهلا عزيزي "..msg.TheRankCmd.."   \n✹  تم مسح {* "..#list.." *} من المحظورين  \n"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "✹ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(VAMBAIR..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "✹ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(VAMBAIR..'is_silent_users:'..msg.chat_id_)
...
redis:del(VAMBAIR..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "✹ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(VAMBAIR..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(VAMBAIR..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "✹ **هذا الامر يخص {المطور,المنشئ} فقط  \n" end
redis:setex(VAMBAIR..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(VAMBAIR..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(VAMBAIR..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(VAMBAIR..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(VAMBAIR..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if MsgText[1] == 'تغير الايدي' and Manager(msg) then 
local List = {
[[
゠𝚄𝚂𝙴𝚁 𖨈 #username 𖥲 .
゠𝙼𝚂𝙶 𖨈 #msgs 𖥲 .
...
if redis:get(VAMBAIR..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(VAMBAIR..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(VAMBAIR..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(VAMBAIR..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(VAMBAIR..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(VAMBAIR.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(VAMBAIR..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(VAMBAIR..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(VAMBAIR..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(VAMBAIR..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(VAMBAIR..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(VAMBAIR..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(VAMBAIR..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(VAMBAIR..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(VAMBAIR..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(VAMBAIR..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "✹ **تم مسح {* "..msgs.." *} من رسائلك .\n"
end

if MsgText[1]== 'جهاتي' then
return '✹ **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(VAMBAIR..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(VAMBAIR..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "✹ **عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(VAMBAIR..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(VAMBAIR..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "✹ **عذرا ليس لديك نقاط لكِ يتم مسحها" end
redis:del(VAMBAIR..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(VAMBAIR..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(VAMBAIR..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(VAMBAIR..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(VAMBAIR..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(VAMBAIR..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(VAMBAIR..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(VAMBAIR..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(VAMBAIR..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(VAMBAIR..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "✹ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:set(VAMBAIR..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "✹ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
if redis:get(VAMBAIR..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(VAMBAIR..'welcome:msg'..msg.chat_id_))
else 
return "✹ **أهلا عزيزي "..msg.TheRankCmd.."  \n✹ نورت المجموعه \n" 
end 
end
...
local groups = redis:smembers(VAMBAIR..'group:ids')
...
local pv = redis:smembers(VAMBAIR..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(VAMBAIR..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
return'✹ حسننا عزيزي .\n✹ الان قم بارسال الصوره للترحيب \n✹ [قناة سورس فمبير](https://t.me/Xx_SorceVambair_xX)'' 
end
...
local Photo_Weloame = redis:get(VAMBAIR..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[✹ اهلا انا بوت]]..redis:get(VAMBAIR..':NameBot:')..[[ .
...
return "✹ لا توجد صوره مضافه للترحيب في البوت \n✹ لاضافه صوره الترحيب ارسل `ضع صوره للترحيب` /n✹ [قناة سورس فمبير](https://t.me/Xx_SorceVambair_xX)'"
end
end

if MsgText[1] == "ضع كليشه المطور" then 
redis:setex(VAMBAIR..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '✹ حسننا عزيزي .\n✹ الان قم بارسال الكليشه \n' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(VAMBAIR..':addnumberusers',MsgText[2]) 
return '✹ ** تم وضـع شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..MsgText[2]..'】* عضـو  .\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'✹ ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(VAMBAIR..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "✹ **هذا الامر يخص {المطور} فقط  \n" end
return '✹ ** عدد المجموعات المفعلة » `'..redis:scard(VAMBAIR..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "✹ **هذا الامر يخص {المطور} فقط  \n" end
return '✹ **عدد المشتركين في البوت : `'..redis:scard(VAMBAIR..'users')..'` \n'
end
...
if not msg.SudoUser then return "✹ **هذا الامر يخص {المطور} فقط  \n" end
if redis:sismember(VAMBAIR..'group:ids',MsgText[2]) then
local name_gp = redis:get(VAMBAIR..'group:name'..MsgText[2])
...
return redis:get(VAMBAIR..":TEXT_SUDO") or '✹ لا توجد كليشه المطور .\n✹ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"✹ **هذا الامر يخص {المطور} فقط  \n" end
if not msg.SudoBase and not redis:get(VAMBAIR..'lock_brod') then 
return "✹ ** الاذاعه مقفوله من قبل المطور الاساسي  ." 
end
redis:setex(VAMBAIR..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(VAMBAIR..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(VAMBAIR..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(VAMBAIR..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "✹ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
redis:del(VAMBAIR..'welcom:witting'..msg.sender_user_id_,
VAMBAIR..'rulse:witting'..msg.sender_user_id_,
VAMBAIR..'rulse:witting'..msg.sender_user_id_,
VAMBAIR..'name:witting'..msg.sender_user_id_,
VAMBAIR..'about:witting'..msg.sender_user_id_,
VAMBAIR..'fwd:all'..msg.sender_user_id_,
VAMBAIR..'fwd:pv'..msg.sender_user_id_,
VAMBAIR..'fwd:groups'..msg.sender_user_id_,
VAMBAIR..'namebot:witting'..msg.sender_user_id_,
VAMBAIR..'addrd_all:'..msg.sender_user_id_,
VAMBAIR..'delrd:'..msg.sender_user_id_,
VAMBAIR..'addrd:'..msg.sender_user_id_,
VAMBAIR..'delrdall:'..msg.sender_user_id_,
VAMBAIR..'text_sudo:witting'..msg.sender_user_id_,
VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_,
VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(VAMBAIR..":VERSION",GetVerison)
return false
else
...
return '✹ اصدار سورس فمبير : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'✹ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس فمبير يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/Xx_SorceVambair_xX"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : فمبير](https://t.me/Xx_SorceVambair_xX)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "بويكا القمد" and msg.type == "pv" then
local inline = {{{text="𝐃𝐄𝐕 𝐁𝐎𝐘𝐊𝐀",url="https://t.me/b_o_y_k_a_a"}}}
send_key(msg.sender_user_id_,'   [بويكا القمد](https://t.me/b_o_y_k_a_a)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "فامبير مطور السورس" and msg.type == "pv" then
local inline = {{{text="مالك السورس اضـغـط هـنـآ ",url="https://t.me/V_a_a_m_b_a_I_r"}}}
send_key(msg.sender_user_id_,'   [المالك فمبير](https://t.me/V_a_a_m_b_a_I_r)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== 'ضع كليشه ستارت ✰➧' then
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'✰➧ارسل لي الكليشه الان') 
return false
end

if MsgText[1]== 'مسح كليشه ستارت ✰➧' then
...
if not msg.SudoBase then return"✹ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '✹ الاحصائيات . \n\n✹ **عدد المجموعات المفعله : '..redis:scard(VAMBAIR..'group:ids')..'\n✹ **عدد المشتركين في البوت : '..redis:scard(VAMBAIR..'users')..'\n'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"✹ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(VAMBAIR..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.Director then return "✹ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names 	= redis:exists(VAMBAIR..'replay:'..msg.chat_id_)
local photo 	= redis:exists(VAMBAIR..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(VAMBAIR..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(VAMBAIR..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(VAMBAIR..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(VAMBAIR..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(VAMBAIR..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(VAMBAIR..'replay:'..msg.chat_id_,VAMBAIR..'replay_photo:group:'..msg.chat_id_,VAMBAIR..'replay_voice:group:'..msg.chat_id_,
VAMBAIR..'replay_animation:group:'..msg.chat_id_,VAMBAIR..'replay_audio:group:'..msg.chat_id_,VAMBAIR..'replay_sticker:group:'..msg.chat_id_,VAMBAIR..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(VAMBAIR..'replay:all')
local photo 	= redis:exists(VAMBAIR..'replay_photo:group:')
local voice 	= redis:exists(VAMBAIR..'replay_voice:group:')
local imation 	= redis:exists(VAMBAIR..'replay_animation:group:')
local audio 	= redis:exists(VAMBAIR..'replay_audio:group:')
local sticker 	= redis:exists(VAMBAIR..'replay_sticker:group:')
local video 	= redis:exists(VAMBAIR..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(VAMBAIR..'replay:all',VAMBAIR..'replay_photo:group:',VAMBAIR..'replay_voice:group:',VAMBAIR..'replay_animation:group:',VAMBAIR..'replay_audio:group:',VAMBAIR..'replay_sticker:group:',VAMBAIR..'replay_video:group:')
...
if not msg.SudoBase then return"✹ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(VAMBAIR..'delrdall:'..msg.sender_user_id_,true) 
return "✹ حسننا عزيزي  .\n✹ الان ارسل الرد لمسحها من  المجموعات ."
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "✹ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:set(VAMBAIR..'delrd:'..msg.sender_user_id_,true)
return "✹ حسننا عزيزي  .\n✹ الان ارسل الرد لمسحها من  للمجموعه ."
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "✹ *│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local names  	= redis:hkeys(VAMBAIR..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(VAMBAIR..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(VAMBAIR..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(VAMBAIR..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(VAMBAIR..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(VAMBAIR..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(VAMBAIR..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(VAMBAIR..'replay:all')
local photo 	= redis:hkeys(VAMBAIR..'replay_photo:group:')
local voice 	= redis:hkeys(VAMBAIR..'replay_voice:group:')
local imation 	= redis:hkeys(VAMBAIR..'replay_animation:group:')
local audio 	= redis:hkeys(VAMBAIR..'replay_audio:group:')
local sticker 	= redis:hkeys(VAMBAIR..'replay_sticker:group:')
local video 	= redis:hkeys(VAMBAIR..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '✹ **لا يوجد ردود مضافه حاليا \n' 
end
local ii = 1
...
if not msg.Director then return "✹ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
redis:setex(VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(VAMBAIR..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "✹ حسننا , الان ارسل كلمه الرد \n"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"✹ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(VAMBAIR..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "✹ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✹ " end
if not redis:get(VAMBAIR..'lave_me'..msg.chat_id_) then 
return "✹ **أهلا عزيزي "..msg.TheRankCmd.."\n✹ ** المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(VAMBAIR..'lave_me'..msg.chat_id_) 
return "✹ **أهلا عزيزي "..msg.TheRankCmd.."\n✹ ** تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "✹ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✹ " end
if redis:get(VAMBAIR..'lave_me'..msg.chat_id_) then 
return "✹ **أهلا عزيزي "..msg.TheRankCmd.."\n✹ ** المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(VAMBAIR..'lave_me'..msg.chat_id_,true)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 𝐕𝐀𝐌𝐁𝐄𝐑 🜻', url="t.me/V_a_a_m_b_a_I_r"}},
{{text = '𝐁𝐎𝐘𝐊𝐀 𝐀𝐋𝐄𝐗 🜻', url="t.me/b_o_y_k_a_a"}},
{{text = '𝐓𝐖𝐒 🜻', url="t.me/VambairrSorce_bot"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐇𝐋 🜻', url="t.me/Xx_SorceVambair_xX"}},
}
...
if not msg.SudoBase then return"✹ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(VAMBAIR..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"✹ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local UserChaneel = redis:get(VAMBAIR..":UserNameChaneel")
if UserChaneel then
...
if redis:get(VAMBAIR..'welc'..msg.chat_id_) == 'on' then
...
local hash = VAMBAIR..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
mmd = redis:get(VAMBAIR..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(VAMBAIR..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(VAMBAIR..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'✹ اهلا عزيزي \n✹ تم تثبيت الامر الجديد\n✓')
redis:del(VAMBAIR..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "✹ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(VAMBAIR..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(VAMBAIR..'CmD:'..msg.chat_id_,cmd)
redis:srem(VAMBAIR..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"✹ اهلا عزيزي\nالامر >"..cmd.."\n✹ تم مسحه من قائمه الاوامر\n")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "✹ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
redis:del(VAMBAIR..'CmD:'..msg.chat_id_)
redis:del(VAMBAIR..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"✹ اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "✹ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local CmDlist = redis:smembers(VAMBAIR..'CmDlist:'..msg.chat_id_)
local t = '✹ قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(VAMBAIR..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(VAMBAIR..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(VAMBAIR..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(VAMBAIR..'welc'..msg.chat_id_,'off')
redis:del(VAMBAIR..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب')
end
end

if Black == 'welcome on' or Black == 'تفعيل الفمبير' then
if redis:get(VAMBAIR..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الفمبير سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الفمبير')
redis:set(VAMBAIR..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل فمبير' then
if redis:get(VAMBAIR..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل فمبير سابقا')
redis:set(VAMBAIR..'welc'..msg.chat_id_,'off')
redis:del(VAMBAIR..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل فمبير')
end
end

if Text == "join on" and msg.SudoUser then
redis:set(VAMBAIR..'joinchnl',true)
sendMsg(msg.chat_id_,msg.id_,'on')
end
if Text and redis:get(VAMBAIR..'setchs') and msg.SudoUser then
redis:set(VAMBAIR..'setch',Text)
sendMsg(msg.chat_id_,msg.id_,'تم تعين القناه علي \n'..Text)
redis:del(VAMBAIR..'setchs')
end
if Text and (Text:match("^setch$")) and msg.SudoUser then
sendMsg(msg.chat_id_,msg.id_,'ارسل معرفك بدون @')
redis:setex(VAMBAIR..'setchs',120,true)
end
...
function tophoto(kara,VAMBAIR)   
if VAMBAIR.content_.ID == "MessageSticker" then        
local bd = VAMBAIR.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(VAMBAIR..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(VAMBAIR..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*✹ * تم حظرك من البوت بسبب التكرار \n') 
end
redis:setex(VAMBAIR..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end

if msg.text=="/start" then 

if msg.SudoBase then
local text = '- شكراً لك لإستخدام سورس فمبير\n- أنت المطور الاساسي هنا\n—————————\n\n- يمكنك الأن التحكم بأوامر البوت عن طريق لوحة التحكم بالبوت\nفقط انقر على الأمر الذي تريده‏'
local keyboard = {
{"فامبير مطور السورس","بويكا القمد"},
{"ضع كليشه ستارت ✰➧"},
{"مسح كليشه ستارت ✰➧"},
{"ضع اسم للبوت","ضع صوره للترحيب"},
{"تفعيل الفمبير","تعطيل فمبير"},
...
redis:sadd(VAMBAIR..'users',msg.sender_user_id_)
if redis:get(VAMBAIR..'lock_service') then 
text = [[✹ أهلاً انا بوت   []]..redis:get(VAMBAIR..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(VAMBAIR.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(VAMBAIR..'lock_twasel') then
...
redis:setex(VAMBAIR.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(VAMBAIR..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(VAMBAIR..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(VAMBAIR..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n✹ تم اضافت الرد . \n-')
elseif msg.photo then 
redis:hset(VAMBAIR..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم اضافه صوره للرد بنجاح\n✹ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(VAMBAIR..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم اضافه بصمه صوت للرد بنجاح\n✹ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(VAMBAIR..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم اضافه متحركه للرد بنجاح\n✹ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(VAMBAIR..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم اضافه فيديو للرد بنجاح\n✹ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(VAMBAIR..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم اضافه للصوت للرد بنجاح\n✹ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(VAMBAIR..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(VAMBAIR..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(VAMBAIR..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(VAMBAIR..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✹ تم اضافت الرد لكل المجموعات . ')
elseif msg.photo then 
redis:hset(VAMBAIR..'replay_photo:group:',klma,photo_id)
redis:del(VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم اضافه صوره للرد العام\n✹ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(VAMBAIR..'replay_voice:group:',klma,voice_id)
redis:del(VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم اضافه بصمه صوت للرد العام\n✹ يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(VAMBAIR..'replay_animation:group:',klma,animation_id)
redis:del(VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم اضافه متحركه للرد العام\n✹ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوره الاتيه ')
elseif msg.video then
redis:hset(VAMBAIR..'replay_video:group:',klma,video_id)
redis:del(VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم اضافه فيديو للرد العام\n✹ يمكنك ارسال ❴ ['..klma..'] ❵لأظهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(VAMBAIR..'replay_audio:group:',klma,audio_id)
redis:del(VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم اضافه للصوت للرد العام\n✹ يمكنك ارسال ❴ ['..klma..'] ❵ لأظهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(VAMBAIR..'replay_sticker:group:',klma,sticker_id)
redis:del(VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(VAMBAIR..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(VAMBAIR..":ForceSub:"..msg.sender_user_id_)
...
redis:set(VAMBAIR..":UserNameChaneel",msg.text)
...
if redis:get(VAMBAIR..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(VAMBAIR..'namebot:witting'..msg.sender_user_id_)
redis:set(VAMBAIR..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"✹ تم تغير اسم البوت  .\n✹ الان اسمه "..Flter_Markdown(msg.text).." \n")
return false
end

if redis:get(VAMBAIR..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(VAMBAIR..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(VAMBAIR..'replay_photo:group:',msg.text)
redis:hdel(VAMBAIR..'replay_voice:group:',msg.text)
redis:hdel(VAMBAIR..'replay_animation:group:',msg.text)
redis:hdel(VAMBAIR..'replay_audio:group:',msg.text)
redis:hdel(VAMBAIR..'replay_sticker:group:',msg.text)
redis:hdel(VAMBAIR..'replay_video:group:',msg.text)
redis:setex(VAMBAIR..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✹ جيد , يمكنك الان ارسال جوا ب الردالعام \n✹ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(VAMBAIR..'delrdall:'..msg.sender_user_id_) then
redis:del(VAMBAIR..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(VAMBAIR..'replay:all',msg.text)
local photo =redis:hget(VAMBAIR..'replay_photo:group:',msg.text)
local voice = redis:hget(VAMBAIR..'replay_voice:group:',msg.text)
local animation = redis:hget(VAMBAIR..'replay_animation:group:',msg.text)
local audio = redis:hget(VAMBAIR..'replay_audio:group:',msg.text)
local sticker = redis:hget(VAMBAIR..'replay_sticker:group:',msg.text)
local video = redis:hget(VAMBAIR..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'✹ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(VAMBAIR..'replay:all',msg.text)
redis:hdel(VAMBAIR..'replay_photo:group:',msg.text)
redis:hdel(VAMBAIR..'replay_voice:group:',msg.text)
redis:hdel(VAMBAIR..'replay_audio:group:',msg.text)
redis:hdel(VAMBAIR..'replay_animation:group:',msg.text)
...
if redis:get(VAMBAIR..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(VAMBAIR..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(VAMBAIR..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "✹ ** تم وضع الكليشه بنجاح كلاتي .\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n")
end
if redis:get(VAMBAIR..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(VAMBAIR..'welcom:witting'..msg.sender_user_id_) 
redis:set(VAMBAIR..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✹ ** تم وضع الترحيب بنجاح كلاتي .\n" )
end
if redis:get(VAMBAIR..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(VAMBAIR..'rulse:witting'..msg.sender_user_id_) 
redis:set(VAMBAIR..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'✹ ** مرحبآ عزيزي\n✹ تم حفظ القوانين بنجاح .\n✹ ارسل [[ القوانين ]] لعرضها \n')
end
if redis:get(VAMBAIR..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(VAMBAIR..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(VAMBAIR..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(VAMBAIR..'linkGroup'..msg.sender_user_id_,link) 
redis:set(VAMBAIR..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'✹ تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(VAMBAIR..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(VAMBAIR..'about:witting'..msg.sender_user_id_) 
...
if redis:get(VAMBAIR..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(VAMBAIR..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(VAMBAIR..'users')  
local groups = redis:smembers(VAMBAIR..'group:ids')
...
if redis:get(VAMBAIR..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(VAMBAIR..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(VAMBAIR..'users')
if #pv >= 300 then
...
if redis:get(VAMBAIR..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(VAMBAIR..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(VAMBAIR..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(VAMBAIR..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(VAMBAIR..':WELCOME_BOT'),[[✹أهلاً انا بوت ]]..redis:get(VAMBAIR..':NameBot:')..[[
✹ أختصاصي حماية‌‏ المجموعات
✹ مـن السبام والتوجيه‌‏ والتكرار والخ...
...
if msg.forward_info and redis:get(VAMBAIR..'fwd:'..msg.sender_user_id_) then
redis:del(VAMBAIR..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(VAMBAIR..'users')
local groups = redis:smembers(VAMBAIR..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(VAMBAIR..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(VAMBAIR..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(VAMBAIR..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'✹ تم تغيير صوره‏‏ الترحيب للبوت .\n')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(VAMBAIR..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(VAMBAIR..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(VAMBAIR..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(VAMBAIR..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(VAMBAIR..'replay:'..msg.chat_id_,msg.text)
redis:hdel(VAMBAIR..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(VAMBAIR..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(VAMBAIR..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(VAMBAIR..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(VAMBAIR..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(VAMBAIR..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(VAMBAIR..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✹ جيد , يمكنك الان ارسال جواب الرد \n✹ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n")
end
end

if redis:get(VAMBAIR..'delrd:'..msg.sender_user_id_) then
redis:del(VAMBAIR..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(VAMBAIR..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(VAMBAIR..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(VAMBAIR..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(VAMBAIR..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(VAMBAIR..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(VAMBAIR..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(VAMBAIR..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'✹ **هذا الرد ليس مضاف في قائمه الردود .')
else
redis:hdel(VAMBAIR..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(VAMBAIR..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(VAMBAIR..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(VAMBAIR..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(VAMBAIR..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(VAMBAIR..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(VAMBAIR..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(VAMBAIR..'welcome:msg'..msg.chat_id_) or "✹ اهلاً عزيزي {الاسم}\n✹ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n✹ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(VAMBAIR..'rulse:msg'..msg.chat_id_) or "✹ مرحباً عزيري القوانين كلاتي .\n✹ ممنوع نشر الروابط\n✹ ممنوع التكلم او نشر صور اباحيه\n✹ ممنوع  اعاده توجيه\n✹ ممنوع التكلم بالسياسة\n✹ الرجاء احترام المدراء والادمنيه .\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(VAMBAIR..'group:name'..msg.chat_id_) or '')))
...
welcome = (redis:get(VAMBAIR..'welcome:msg'..msg.chat_id_) or "✹ اهلن بك عزيزي {الاسم}\n✹ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n✹ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(VAMBAIR..'rulse:msg'..msg.chat_id_) or "✹ مرحباً عزيري القوانين كلاتي .\n✹ ممنوع نشر الروابط\n✹ ممنوع التكلم او نشر صور اباحيه\n✹ ممنوع  اعاده توجيه\n✹ ممنوع التكلم بالسياسة\n✹ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
--------------------------------------------
if msg.adduser and redis:get(VAMBAIR..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(VAMBAIR..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(VAMBAIR..'welcome:get'..msg.chat_id_)
end
redis:setex(VAMBAIR..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(VAMBAIR..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(VAMBAIR..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_VAMBAIR = (redis:get(VAMBAIR..'num_msg_VAMBAIR'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_VAMBAIR) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(VAMBAIR..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"✹ العضو » "..USERNAME.."\n✹ قمـت بتكرار اكثر مـن "..NUM_MSG_VAMBAIR.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
redis:setex(VAMBAIR..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(VAMBAIR..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(VAMBAIR..'lock_woring'..msg.chat_id_) and not redis:get(VAMBAIR..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(VAMBAIR..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(VAMBAIR..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(VAMBAIR..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'✹ ** لا يمكنني مسح الرساله المخالفه .\n✹ ** لست مشرف او ليس لدي صلاحيه  الحذف \n')    
end
if redis:get(VAMBAIR..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(VAMBAIR..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(VAMBAIR..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(VAMBAIR..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(VAMBAIR..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(VAMBAIR..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(VAMBAIR..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(VAMBAIR..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(VAMBAIR..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(VAMBAIR..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(VAMBAIR..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(VAMBAIR..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(VAMBAIR..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(VAMBAIR..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(VAMBAIR..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(VAMBAIR..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(VAMBAIR..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(VAMBAIR..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(VAMBAIR..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(VAMBAIR..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(VAMBAIR..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(VAMBAIR..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(VAMBAIR..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(VAMBAIR..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(VAMBAIR..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(VAMBAIR..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(VAMBAIR..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(VAMBAIR..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(VAMBAIR..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(VAMBAIR..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(VAMBAIR..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(VAMBAIR..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(VAMBAIR..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(VAMBAIR..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(VAMBAIR..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(VAMBAIR..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(VAMBAIR..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(VAMBAIR..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(VAMBAIR..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(VAMBAIR..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(VAMBAIR..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(VAMBAIR..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
if text == 'بويكا' or text == 'بويكا' or text == 'بودي' or text == 'بودي' or text == 'بويكا الهكر' or text == 'بويكا'  or text == 'الهكر بويكا' then
local Text = [[
مطور السورس . يمكنك التواصل معه عن طريق معرفه
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 𝐁𝐎𝐘𝐊𝐀 🇾🇪',url="t.me/b_o_y_k_a_a"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'فمبير' or text == 'فمبير المطور' or text == 'المطور فمبير' or text == 'فمبير' or text == 'المطور فمبير' or text == 'فمبير المطور' then
local Text = [[
مطور السورس . يمكنك التواصل معه عن طريق معرفه
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝔻𝔼𝕍↝𝕍𝔸𝕄𝔹𝔸𝕆ℝ 🇾🇪',url="t.me/V_a_a_m_b_a_I_r"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
  elseif Text== "سورس فمبير" or Text== "سورس فامبير" then return  sendMsg(msg.chat_id_,msg.id_,"[احسن سورس مصري ↯](https://t.me/Xx_SorceVambair_xX)")
 ...
 elseif Text== "ايدي" or Text=="ايدي 🆔" then 
  ...
  elseif Text=="عايز رابط حذف" or Text=="عايزه رابط حذف" or Text=="عايز احذف" or Text=="رابط الحذف" then
  return sendMsg(msg.chat_id_,msg.id_,[[
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/Xx_SorceVambair_xX) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://t.me/Xx_SorceVambair_xX)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/Xx_SorceVambair_xX)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/Xx_SorceVambair_xX)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/Xx_SorceVambair_xX)")
end 
end 
elseif Text== "مين ضافني" or Text== "منو ضافني"  then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/Xx_SorceVambair_xX) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه](https://t.me/Xx_SorceVambair_xX)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Xx_SorceVambair_xX)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Xx_SorceVambair_xX)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[انت دخلت عبر الرابط](https://t.me/Xx_SorceVambair_xX)")
...
if not redis:get('kar') then
  ...
  json_data = '{"BotID": '..VAMBAIR..',"UserBot": "'..Bot_User..'","Groups" : {'
  local All_Groups_ID = redis:smembers(VAMBAIR..'group:ids')
  for key,GroupS in pairs(All_Groups_ID) do
  local NameGroup = (redis:get(VAMBAIR..'group:name'..GroupS) or '')
  ...
  local admins = redis:smembers(VAMBAIR..'admins:'..GroupS)
  if #admins ~= 0 then
  json_data =  json_data..',"Admins" : {'
  for key,value in pairs(admins) do
  local info = redis:hgetall(VAMBAIR..'username:'..value)
  if info then 
  ...
  local creators = redis:smembers(VAMBAIR..':MONSHA_BOT:'..GroupS)
  if #creators ~= 0 then
  ...
  local creator = redis:smembers(VAMBAIR..':KARA_BOT:'..GroupS)
  if #creator ~= 0 then
  ...
  local owner = redis:smembers(VAMBAIR..'owners:'..GroupS)
  if #owner ~= 0 then
  ...
  if redis:get(VAMBAIR..'CheckExpire::'..msg.chat_id_) then
  local ExpireDate = redis:ttl(VAMBAIR..'ExpireDate:'..msg.chat_id_)
  if not ExpireDate and not msg.SudoUser then
  rem_data_group(msg.chat_id_)
  sendMsg(SUDO_ID,0,'✹ انتهى الاشتراك في احد المجموعات .\n✹ المجموعه : '..FlterName(redis:get(VAMBAIR..'group:name'..msg.chat_id_))..'.\n✹ ايدي : '..msg.chat_id_)
  sendMsg(msg.chat_id_,0,'✹ انتهى الاشتراك البوت.\n✹ سوف اغادر المجموعه فرصه سعيده .\n✹ او راسل المطور للتجديد '..SUDO_USER..' 🍃')
  return StatusLeft(msg.chat_id_,our_id)
  else
  local DaysEx = (redis:ttl(VAMBAIR..'ExpireDate:'..msg.chat_id_) / 86400)
